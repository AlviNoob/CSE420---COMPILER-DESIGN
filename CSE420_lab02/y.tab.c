...
{
       0,    69,    69,    79,    86,    95,   102,   111,   111,   133,
     133,   157,   170,   182,   195,   210,   210,   244,   244,   266,
     284,   292,   300,   310,   328,   349,   366,   389,   396,   405,
     412,   420,   427,   434,   441,   448,   455,   462,   469,   478,
     485,   494,   502,   511,   518,   527,   534,   543,   550,   559,
     567,   576,   584,   594,   601,   608,   617,   624,   631,   638,
     645,   652,   659,   668,   676,   684,   691
};
#endif
...
#line 227 "24141164.y"
    { 
                ...
                // Note that function parameters should be in the current 
...
int main(int argc, char *argv[])
{
	...
	yyin = fopen(argv[1], "r");
	outlog.open("24141164_log.txt", ios::trunc);
