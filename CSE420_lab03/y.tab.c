...
{
       0,    75,    75,    85,    92,   101,   108,   117,   117,   159,
     159,   194,   207,   219,   232,   247,   247,   275,   275,   297,
     318,   326,   334,   344,   363,   386,   404,   428,   435,   444,
     451,   459,   466,   473,   480,   487,   494,   501,   512,   521,
     528,   537,   548,   580,   588,   650,   658,   668,   676,   686,
     695,   708,   717,   756,   764,   772,   783,   801,   874,   882,
     890,   898,   905,   914,   923,   932,   962
};
#endif
...
#line 117 "24141164_22101142.y"
    {
        ...
        symbol_info temp_var((yyvsp[(2) - (5)])->getname(), "ID");
...
#line 345 "24141164_22101142.y"
    {
			...
			if(is_variable_declared_current_scope((yyvsp[(3) - (3)])->getname())) {
                errorlog << "At line no: " << lines << " Multiple declaration of variable " << (yyvsp[(3) - (3)])->getname() << endl << endl;
				error_count++;
                (yyval) = new symbol_info((yyvsp[(1) - (3)])->getname() + "," + (yyvsp[(3) - (3)])->getname(), "decl_list");
            } else {
...
#line 364 "24141164_22101142.y"
    {
            ...
            if(is_variable_declared_current_scope((yyvsp[(3) - (6)])->getname())) {
				errorlog << "At line no: " << lines << " Multiple declaration of variable " << (yyvsp[(3) - (6)])->getname() << endl << endl;
				error_count++;
                (yyval) = new symbol_info((yyvsp[(1) - (6)])->getname() + "," + (yyvsp[(3) - (6)])->getname() + "[" + (yyvsp[(5) - (6)])->getname() + "]", "decl_list");
            } else { 
...
#line 387 "24141164_22101142.y"
    {
			...
			if(is_variable_declared_current_scope((yyvsp[(1) - (1)])->getname())) {
				errorlog << "At line no: " << lines << " Multiple declaration of variable " << (yyvsp[(1) - (1)])->getname() << endl << endl;
				error_count++;
                (yyval) = new symbol_info((yyvsp[(1) - (1)])->getname(), "decl_list");
            } else {
...
#line 405 "24141164_22101142.y"
    {
            ...
            if(is_variable_declared_current_scope((yyvsp[(1) - (4)])->getname())) {
				errorlog << "At line no: " << lines << " Multiple declaration of variable " << (yyvsp[(1) - (4)])->getname() << endl << endl;
				error_count++;
                (yyval) = new symbol_info((yyvsp[(1) - (4)])->getname() + "[" + (yyvsp[(3) - (4)])->getname() + "]", "decl_list");
            } else {
...
#line 495 "24141164_22101142.y"
  ...
  case 37:
/* Line 1792 of yacc.c  */
#line 502 "24141164_22101142.y"
    {
	    	outlog<<"At line no: "<<lines<<" statement : PRINTLN LPAREN ID RPAREN SEMICOLON "<<endl<<endl;
			outlog<<"printf("<<(yyvsp[(3) - (5)])->getname()<<");"<<endl<<endl; 
			symbol_info* sym = table->lookup((yyvsp[(3) - (5)]));
			if(sym == NULL) {
...
#line 529 "24141164_22101142.y"
  ...
  case 41:
/* Line 1792 of yacc.c  */
#line 538 "24141164_22101142.y"
    {
	    outlog<<"At line no: "<<lines<<" variable : ID "<<endl<<endl;
		outlog<<(yyvsp[(1) - (1)])->getname()<<endl<<endl;
		symbol_info* sym = table->lookup((yyvsp[(1) - (1)]));	
...
#line 549 "24141164_22101142.y"
    {
		...
		symbol_info temp((yyvsp[(1) - (4)])->getname(), "ID");
...
#line 581 "24141164_22101142.y"
  ...
  case 44:
/* Line 1792 of yacc.c  */
#line 589 "24141164_22101142.y"
    {
	    	outlog<<"At line no: "<<lines<<" expression : variable ASSIGNOP logic_expression "<<endl<<endl;
			outlog<<(yyvsp[(1) - (3)])->getname()<<"="<<(yyvsp[(3) - (3)])->getname()<<endl<<endl;


		    std::string var_name = (yyvsp[(1) - (3)])->getname();
			...
			if (sym == NULL) {
        		...
        		if ((yyvsp[(1) - (3)])->get_data_type() == "int" && (yyvsp[(3) - (3)])->get_data_type() == "float") {
            		errorlog << "At line no: " << lines << " Warning: Assignment of float value into variable of integer type" << endl << endl;
            		error_count++;
        		}
				else if ((yyvsp[(1) - (3)])->get_data_type() == "int" && (yyvsp[(3) - (3)])->get_data_type() != "int") {
        		...
        		if (sym != NULL && sym->get_is_array()) {
            		...
            		if ((yyvsp[(1) - (3)])->getname().find('[') == std::string::npos) {
                	errorlog << "At line no: " << lines << " variable is of array type : " << sym->getname() << endl << endl;
                	error_count++;
            		}
        		} 
				else if (sym != NULL && (yyvsp[(1) - (3)])->get_data_type() != (yyvsp[(3) - (3)])->get_data_type() && !((yyvsp[(1) - (3)])->get_data_type() == "int" && (yyvsp[(3) - (3)])->get_data_type() == "float")) {
            		errorlog << "At line no: " << lines << " variable is of " << (yyvsp[(1) - (3)])->get_data_type() << " type : " << (yyvsp[(1) - (3)])->getname() << endl << endl;
            		error_count++;
        		}

        		if ((yyvsp[(3) - (3)])->get_data_type() == "bool" && (yyvsp[(1) - (3)])->get_data_type() != "int") {
  ...
  case 45:
/* Line 1792 of yacc.c  */
#line 651 "24141164_22101142.y"
    {
	    	outlog<<"At line no: "<<lines<<" logic_expression : rel_expression "<<endl<<endl;
			outlog<<(yyvsp[(1) - (1)])->getname()<<endl<<endl;
			
			(yyval) = new symbol_info((yyvsp[(1) - (1)])->getname(),"lgc_expr");
			(yyval)->set_data_type((yyvsp[(1) - (1)])->get_data_type()); //edit
	     }
    break;

  case 46:
/* Line 1792 of yacc.c  */
#line 659 "24141164_22101142.y"
    {
			...
			(yyval)->set_data_type("bool"); //edit
	     }
    break;

  case 47:
/* Line 1792 of yacc.c  */
#line 669 "24141164_22101142.y"
    {
...
#line 718 "24141164_22101142.y"
    {
			...
			else if ((yyvsp[(2) - (3)])->getname() == "/" || (yyvsp[(2) - (3)])->getname() == "*") {
            	if ((yyvsp[(1) - (3)])->get_data_type() == "float" || (yyvsp[(3) - (3)])->get_data_type() == "float")
                	(yyval)->set_data_type("float");
            	else
                	(yyval)->set_data_type("int");
...
#line 773 "24141164_22101142.y"
  ...
  case 56:
/* Line 1792 of yacc.c  */
#line 784 "24141164_22101142.y"
    {
	    outlog<<"At line no: "<<lines<<" factor : variable "<<endl<<endl;
		outlog<<(yyvsp[(1) - (1)])->getname()<<endl<<endl;
        std::string var_name = (yyvsp[(1) - (1)])->getname();
        size_t bracket_pos = var_name.find('[');
        if (bracket_pos != std::string::npos) {
            var_name = var_name.substr(0, bracket_pos);
        }
...
#line 802 "24141164_22101142.y"
    {
        ...
        if (!func) {
            ...
            errorlog << "At line no: " << lines << " A function call cannot be made with non-function type identifier: " << (yyvsp[(1) - (4)])->getname() << endl << endl;
            error_count++;
            (yyval)->set_data_type("error");
        } else {
            if ((yyvsp[(1) - (4)])->getname() == "printf" && (!func || !func->get_is_function())) {
            ...
            std::string args_str = (yyvsp[(3) - (4)])->get_data_type();
            ...
            if (arg_types.size() != params.size()) {
                if (!is_void_func || ((yyval)->get_data_type() != "void")) {
                ...
                std::string arg_names_str = (yyvsp[(3) - (4)])->getname();
...
#line 933 "24141164_22101142.y"
    {
				...
				std::string arg_type = (yyvsp[(3) - (3)])->get_data_type();
    			std::string arg_name = (yyvsp[(3) - (3)])->getname();
				...
				(yyval)->set_data_type((yyvsp[(1) - (3)])->get_data_type() + "," + arg_type);				
		  }
    break;

  case 66:
/* Line 1792 of yacc.c  */
#line 963 "24141164_22101142.y"
    {
				...
				std::string arg_type = (yyvsp[(1) - (1)])->get_data_type();
				std::string arg_name = (yyvsp[(1) - (1)])->getname();
