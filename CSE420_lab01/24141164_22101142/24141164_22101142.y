...
%token IF ELSE WHILE FOR DO INT BREAK CHAR FLOAT VOID SWITCH DEFAULT GOTO DOUBLE RETURN CASE CONTINUE PRINTLN CONST_INT CONST_FLOAT ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COMMA COLON SEMICOLON ID
...
declaration_list : declaration_list COMMA ID
	{
		...
		$$ = new symbol_info($1->getname() + "," + $3->getname(), "dclr_list");
	}
	| declaration_list COMMA ID LTHIRD CONST_INT RTHIRD
	{
		...
		$$ = new symbol_info($1->getname() + "," + $3->getname() +"[" + $5->getname() + "]","dclr_list");
	}
	| ID
	{
		...
		$$ = new symbol_info($1->getname(),"dclr_list");
	}
...
factor : variable
	{
		...
		$$ = new symbol_info($1->getname(),"factr");
	}
 	| ID LPAREN argument_list RPAREN
	{
		...
		$$ = new symbol_info($1->getname() + "(" + $3->getname() + ")","factr");
	}
 	| LPAREN expression RPAREN
	{
		...
		$$ = new symbol_info("(" + $2->getname()+ ")","factr");
	}
 	| CONST_INT
	{
 	...
 	| variable INCOP
	{
		...
		$$ = new symbol_info($1->getname() + $2->getname(),"factr");
	}
 	| variable DECOP
	{
